...
//				e1.printStackTrace();
	...
	boolean onHandlePush(Activity activity)
	{
		...
		//	mPushListener.onPushReceived(mLastBundle);
		
		/*Class c = null;
		try {
			c = Class.forName("com.yoero.bingo.activities.BingoMainActivity");
		} catch (ClassNotFoundException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		Intent startGameIntent = new Intent(activity, c);
		startGameIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startGameIntent.putExtras(mLastBundle);
	...
	private IOnPushReceived mPushListener;
	public void setOnPushReceivedListener(IOnPushReceived pListener){
		mPushListener = pListener;
	}
	
	public interface IOnPushReceived{
		public void onPushReceived(Bundle pPushBundle);
	}
}
